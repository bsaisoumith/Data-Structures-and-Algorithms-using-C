...
{
	MLIST *li;
	init_list(&li); // sending address of pointer to the function to make pointer to null and to make local pointer of main function point to null
	createList(&li);
	displayList(&li);
    return 0;
}
